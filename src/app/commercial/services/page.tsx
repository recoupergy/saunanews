      ...
      <section className="bg-charcoal">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <h1 className="font-editorial text-4xl sm:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6">
            Your sauna. Your experience. Fully delivered.
          </h1>
          <p className="text-lg sm:text-xl text-white/75 max-w-3xl leading-relaxed mb-8">
            Every commercial sauna project is different. We align manufacturing, design integration, and construction support around your exact goals—from first concept through final on-site installation.
          </p>
        </div>
      </section>
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
              ...
              <div className="md:col-span-8 space-y-4 text-base text-charcoal/80 leading-relaxed">
                ...
                <p>
                  This ensures that the surrounding architecture — including concrete slabs, electrical rough-ins, and HVAC exhaust pathways — is perfectly aligned with the sauna requirements before construction begins. We also manage the specification of surface materials, from thermo-treated aspen to custom High-Pressure Laminate (HPL) exteriors for outdoor units.
                </p>
              </div>
            </div>
      ...
      <section className="bg-slate text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 text-center">
          <h2 className="font-editorial text-3xl font-bold mb-6">
            Ready to shape your tailor-made sauna?
          </h2>
          <p className="text-lg text-white/75 mb-8 max-w-2xl mx-auto">
            Share your ideas, requirements, and timeline through our intake form. Our commercial team will map the right technical, design, and delivery plan for your space.
          </p>
          <Link
